...
const AcademicScores = () => {
    ...
    const handleNavigate = async () => {
        setIsSaving(true);
        try {
            // Prepare updated data with scores (CBSE doesn't have Tamil)
            const updatedData = {
                ...applicationData,
                mediumOfStudy,
                schoolName,
                yearOfPassing,
                registrationNo,
                englishMarks: scores[0].obtained,
                mathsMarks: scores[1].obtained,
                physicsMarks: scores[2].obtained,
                chemistryMarks: scores[3].obtained,
                csOrBioMarks: scores[4].obtained,
